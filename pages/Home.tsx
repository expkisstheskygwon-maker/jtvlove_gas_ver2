               ...
               {!isCustomHero && fade && (
                 <div className="absolute top-1/4 -right-4 bg-white/90 dark:bg-zinc-800/90 backdrop-blur px-4 py-2 rounded-2xl shadow-xl border border-primary/20 animate-bounce">
                    <div className="flex items-center gap-2">
                       ...
                       <span className="text-xs font-black uppercase tracking-tighter">최고 등급 엘리트</span>
                    </div>
                 </div>
               )}
             </div>
      ...
      <section className="py-16 px-4 bg-background-light dark:bg-background-dark/50">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-8 px-4">
            <div>
              <h3 className="text-xs font-bold text-primary uppercase tracking-[0.2em] mb-1">인기 CCA 리스트</h3>
              <h2 className="text-2xl font-bold">이번 주 화제의 홍보 대사</h2>
            </div>
      ...
      <section className="py-20 px-4 bg-background-dark text-white overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12">
          <div className="lg:w-1/3">
            <span className="text-primary font-bold tracking-[0.3em] uppercase text-xs mb-4 block">이달의 추천 업소</span>
            <h2 className="text-4xl font-extrabold mb-8 font-display">최고의 <span className="text-primary">JTV</span> 라운지</h2>
